    ...
    <div class="flex-center position-ref full-height">
        ...
        <div class="content">
            ...
            <div class="links">
                ...
                <?= $this->erp->logged_in() ? '<a href="'.shop_url('orders').'">'.lang('orders').'</a>' : '<a href="'.site_url('login').'">'.lang('login').'</a>'; ?>
                <?= ($this->erp->logged_in() && (!$this->erp->in_group('customer') && !$this->erp->in_group('customer'))) ? '<a href="'.site_url('admin').'">'.lang('dashboard').'</a>' : ''; ?>
            </div>
        </div>
    </div>
</body>
