                                                ...
                                                <div class="details" style="transition: all 100ms ease-out 0s;">
                                                    ...
                                                    <div class="stats-container">
                                                        ...
                                                        <span class="product_price">
                                                            <?php
                                                            if ($fp->promotion) {
                                                                echo '<del class="text-red">'.$this->erp->convertMoney(isset($fp->special_price) && !empty(isset($fp->special_price)) ? $fp->special_price : $fp->price).'</del><br>';
                                                                echo $this->erp->convertMoney($fp->promo_price);
                                                            } else {
                                                                echo $this->erp->convertMoney(isset($fp->special_price) && !empty(isset($fp->special_price)) ? $fp->special_price : $fp->price);
                                                            }
                                                            ?>
                                                        </span>
                                                        <?php } ?>
