                                ...
                                <div class="well well-sm">
                                    <div class="row bold">
                                        ...
                                        <div class="col-xs-7 text-right order_barcodes">
                                            ...
                                            <?= $this->erp->qrcode('link', urlencode(shop_url('quotes/' . $inv->id)), 2); ?>
                                        </div>
                                    ...
                                    <table class="table table-bordered table-hover table-striped print-table order-table">
                                        ...
                                        <tfoot>
                                            ...
                                            <?php if ($inv->order_discount != 0) {
                                                echo '<tr><td colspan="' . $col . '" style="text-align:right;">' . lang("order_discount") . ' (' . $default_currency->code . ')</td><td style="text-align:right; padding-right:10px;">'.($inv->order_discount_id ? '<small>('.$inv->order_discount_id.')</small> ' : '') . $this->erp->formatMoney($inv->order_discount) . '</td></tr>';
                                            }
                                            ?>
