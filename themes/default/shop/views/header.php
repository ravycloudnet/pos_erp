                    ...
                    <div class="row">
                        ...
                        ?>
                            ...
                            <ul class="list-inline nav pull-right">
                                <?php
                                if (DEMO) {
                                    echo '<li class="hidden-xs hidden-sm"><a href="https://codecanyon.net/item/shop-module/20046278?ref=CloudNET" class="green" target="_blank"><i class="fa fa-shopping-cart"></i> Buy Now!</a></li>';
                                }
                                ?>
        ...
        <div class="page-contents padding-bottom-no">
            <div class="container">
                <div class="alert alert-info margin-bottom-no">
                    <p>
                        <strong>Shop module is not complete item but add-on to iCloudERP and is available separately.</strong><br>
                        This is joint demo for main item (iCloudERP) and add-ons (POS & Shop Module). Please check the item page on codecanyon.net for more info about what's not included in the item and you must read the page there before purchase. Thank you
                    </p>
                </div>
            </div>
        </div>
