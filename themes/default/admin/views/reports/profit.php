            ...
            <table width="100%" class="stable">
                <tr>
                    ...
                    <td style="text-align:right; border-bottom: 1px solid #EEE;"><h4>
                            <span><?= $this->erp->formatMoney($costing->sales); ?></span></h4>
                            <!-- <span><?= $this->erp->formatMoney($costing->sales).' ('.$this->erp->formatMoney($costing->net_sales).')'; ?></span></h4> -->
                    </td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="text-align:right; border-bottom: 1px solid #EEE;"><h4>
                            <span><?= $this->erp->formatMoney($costing->cost); ?></span>
