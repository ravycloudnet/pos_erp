    ...
    <div class="col-xs-4" style="padding-left:0; padding-right:0; padding-bottom:15px; margin-bottom:150px;">
        <div style="padding: 5px 10px; color: #FFF; background: #428bca;">
            ...
            <h4 class="bold" style="color:#FFF;"><?= $warehouse_report['warehouse']->name.' ('.$warehouse_report['warehouse']->code.')'; ?></h4>
                ...
                <h3 class="bold text-center"><?= $this->erp->formatMoney(($warehouse_report['total_sales']->total_amount) - ($warehouse_report['total_purchases']->total_amount)) ?></h3>
                ...
                <h3 class="bold text-center">
                    <?= $this->erp->formatMoney((($warehouse_report['total_sales']->total_amount-$warehouse_report['total_sales']->tax))-($warehouse_report['total_purchases']->total_amount-$warehouse_report['total_purchases']->tax)); ?>
                </h3>
                <p class="bold text-center">
                ...
                <h3 class="bold text-center"><?= $this->erp->formatMoney($warehouse_report['total_expenses']->total_amount); ?></h3>
                <p class="bold text-center">
