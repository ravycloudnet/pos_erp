                        ...
                        <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="small-box padding1010 bblue">
                                            <h3><?= isset($sale_tax->grand_total) ? $this->erp->formatMoney($sale_tax->grand_total) : '0.00' ?></h3>
                                            <p><?= lang('sales_amount') ?></p>
                                        </div>
                                    </div>
                                    <!-- <div class="col-sm-3">
                                        <div class="small-box padding1010 bdarkGreen">
                                            <h3><?= isset($sale_tax->paid) ? $this->erp->formatMoney($sale_tax->paid) : '0.00' ?></h3>
                                            <p><?= lang('received_payment') ?></p>
                                        </div>
                                    </div> -->
                                    <div class="col-sm-4">
                                        <div class="small-box padding1010 bpurple">
                                            <h3><?= isset($sale_tax->product_tax) ? $this->erp->formatMoney($sale_tax->product_tax) : '0.00' ?></h3>
                                            <p><?= lang('total_product_tax') ?></p>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="small-box padding1010 borange">
                                            <h3><?= isset($sale_tax->order_tax) ? $this->erp->formatMoney($sale_tax->order_tax) : '0.00' ?></h3>
                            ...
                            <div class="col-sm-6">
                                <div class="small-box col-sm-4 padding1010 bdarkGreen">
                                    <h3><?= isset($sale_tax->igst) ? $this->erp->formatMoney($sale_tax->igst) : '0.00' ?></h3>
                                    <p><?= lang('igst') ?></p>
                                </div>
                                <div class="small-box col-sm-4 padding1010 bpurple">
                                    <h3><?= isset($sale_tax->cgst) ? $this->erp->formatMoney($sale_tax->cgst) : '0.00' ?></h3>
                                    <p><?= lang('cgst') ?></p>
                                </div>
                                <div class="small-box col-sm-4 padding1010 borange">
                                    <h3><?= isset($sale_tax->sgst) ? $this->erp->formatMoney($sale_tax->sgst) : '0.00' ?></h3>
                                    <p><?= lang('sgst') ?></p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="small-box padding1010 bblue">
                                            <h3><?= isset($purchase_tax->grand_total) ? $this->erp->formatMoney($purchase_tax->grand_total) : '0.00' ?></h3>
                                            <p><?= lang('sales_amount') ?></p>
                                        </div>
                                    </div>
                                    <!-- <div class="col-sm-3">
                                        <div class="small-box padding1010 bdarkGreen">
                                            <h3><?= isset($purchase_tax->paid) ? $this->erp->formatMoney($purchase_tax->paid) : '0.00' ?></h3>
                                            <p><?= lang('received_payment') ?></p>
                                        </div>
                                    </div> -->
                                    <div class="col-sm-4">
                                        <div class="small-box padding1010 bpurple">
                                            <h3><?= isset($purchase_tax->product_tax) ? $this->erp->formatMoney($purchase_tax->product_tax) : '0.00' ?></h3>
                                            <p><?= lang('total_product_tax') ?></p>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="small-box padding1010 borange">
                                            <h3><?= isset($purchase_tax->order_tax) ? $this->erp->formatMoney($purchase_tax->order_tax) : '0.00' ?></h3>
                                            <p><?= lang('total_order_tax') ?></p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-sm-6">
                                <div class="small-box col-sm-4 padding1010 bdarkGreen">
                                    <h3><?= isset($purchase_tax->igst) ? $this->erp->formatMoney($purchase_tax->igst) : '0.00' ?></h3>
                                    <p><?= lang('igst') ?></p>
                                </div>
                                <div class="small-box col-sm-4 padding1010 bpurple">
                                    <h3><?= isset($purchase_tax->cgst) ? $this->erp->formatMoney($purchase_tax->cgst) : '0.00' ?></h3>
                                    <p><?= lang('cgst') ?></p>
                                </div>
                                <div class="small-box col-sm-4 padding1010 borange">
                                    <h3><?= isset($purchase_tax->sgst) ? $this->erp->formatMoney($purchase_tax->sgst) : '0.00' ?></h3>
                                    <p><?= lang('sgst') ?></p>
                                </div>
                            </div>
                        </div>
