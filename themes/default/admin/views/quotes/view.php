            ...
            <div class="col-lg-12">
                ...
                <div class="col-xs-8 pull-right">
                    <div class="col-xs-12 text-right order_barcodes">
                        ...
                        <?= $this->erp->qrcode('link', urlencode(admin_url('quotes/view/' . $inv->id)), 2); ?>
                    </div>
                    <div class="clearfix"></div>
                </div>
                    ...
                    <table class="table table-bordered table-hover table-striped print-table order-table">
                        ...
                        foreach ($rows as $row):
                            ...
                            <tr>
                                ...
                                <td style="text-align:right; width:100px; padding-right:10px;"><?= $this->erp->formatMoney($row->unit_price); ?></td>
                                <?php
                                if ($Settings->tax1 && $inv->product_tax > 0) {
