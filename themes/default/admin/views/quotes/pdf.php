                ...
                <div class="col-xs-6">
                    <div class="bold">
                        ...
                        <div class="order_barcodes">
                            ...
                            <?php /*echo $this->erp->qrcode('link', urlencode(admin_url('quotes/view/' . $inv->id)), 2);*/ ?>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                </div>
                ...
                <table class="table table-bordered table-hover table-striped print-table order-table" style="margin-top: 15px;">
                    ...
                    foreach ($rows as $row):
                        ...
                        <tr>
                            ...
                            ?>
                            <td style="text-align:right; width:100px;"><?= $this->erp->formatMoney($row->subtotal); ?></td>
                        </tr>
                        <?php
                        $r++;
                    endforeach;
                    ...
                    if ($inv->order_discount != 0) {
                        echo '<tr><td colspan="' . $col . '" style="text-align:right;">' . lang("order_discount") . ' (' . $default_currency->code . ')</td><td style="text-align:right;">'.($inv->order_discount_id ? '<small>('.$inv->order_discount_id.')</small> ' : '') . $this->erp->formatMoney($inv->order_discount) . '</td></tr>';
                    }
