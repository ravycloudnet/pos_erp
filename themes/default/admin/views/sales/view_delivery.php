            ...
            <div class="table-responsive">
                <table class="table table-bordered">
                    ...
                    <tr>
                        ...
                        <td width="70%"><?= $this->erp->hrld($delivery->date); ?></td>
                    </tr>
                    <tr>
                    ...
                    <?php if ($delivery->note) { ?>
                        <tr>
                            <td><?= lang("note"); ?></td>
                            <td><?= $this->erp->decode_html($delivery->note); ?></td>
                        </tr>
                    <?php } ?>
                    </tbody>
                ...
                <table class="table table-bordered table-hover table-striped">
                    ...
                    foreach ($rows as $row): ?>
                        <tr>
                            ...
                            <td style="width: 150px; text-align:center; vertical-align:middle;"><?= $this->erp->formatQuantity($row->unit_quantity).' '.$row->product_unit_code; ?></td>
                        </tr>
                        <?php
                        $r++;
                    endforeach;
