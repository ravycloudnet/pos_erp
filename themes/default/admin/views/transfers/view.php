            ...
            <div class="well well-sm">
                <div class="row bold">
                    ...
                    <div class="col-xs-6 pull-right text-right order_barcodes">
                        <img src="<?= admin_url('misc/barcode/'.$this->erp->base64url_encode($transfer->transfer_no).'/code128/74/0/1'); ?>" alt="<?= $transfer->transfer_no; ?>" class="bcimg" />
                        <?= $this->erp->qrcode('link', urlencode(admin_url('transfers/view/' . $transfer->id)), 2); ?>
                    </div>
                ...
                <table class="table table-bordered table-hover table-striped order-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <?php } ?>
                            <td style="text-align:center; width:80px; "><?= $this->erp->formatQuantity($row->unit_quantity).' '.$row->product_unit_code; ?></td>
                            <td style="width: 100px; text-align:right; vertical-align:middle;"><?= $this->erp->formatMoney($row->net_unit_cost); ?></td>
                            <?php if ($Settings->tax1) {
                            ...
                            <td style="width:100px; text-align:right; vertical-align:middle;"><?= $this->erp->formatMoney($row->subtotal); ?></td>
                        </tr>
                        <?php $r++;
                        endforeach; ?>
                    </tbody>
                    <tfoot>
                        ...
                        <tr>
                            ...
                            <td style="text-align:right;">
                                <?= $this->erp->formatMoney($transfer->total_tax); ?>
                            </td>
                            <td style="text-align:right;">
                                <?= $this->erp->formatMoney($transfer->total+$transfer->total_tax); ?>
                            </td>
                        </tr>
                        <?php if ($Settings->indian_gst) {
                            if ($transfer->cgst > 0) {
