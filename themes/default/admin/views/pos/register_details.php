            ...
            <table width="100%" class="stable">
                ...
                <tr>
                    ...
                    <td style="text-align:right;border-bottom: 1px solid #DDD;"><h4>
                            <span><?= $this->erp->formatMoney($gcsales->paid ? $gcsales->paid : '0.00') . ' (' . $this->erp->formatMoney($gcsales->total ? $gcsales->total : '0.00') . ')'; ?></span>
                        </h4></td>
                </tr>
                ...
                <?php if ($pos_settings->authorize) { ?>
                    <tr>
                        ...
                        <td style="text-align:right;border-bottom: 1px solid #DDD;"><h4>
                                <span><?= $this->erp->formatMoney($authorizesales->paid ? $authorizesales->paid : '0.00') . ' (' . $this->erp->formatMoney($authorizesales->total ? $authorizesales->total : '0.00') . ')'; ?></span>
                            </h4></td>
                    </tr>
                <?php } ?>
                <tr>
                ...
                <tr>
                    ...
                    <td style="text-align:right;border-top: 1px solid #DDD;"><h4>
                            <span><?= $this->erp->formatMoney($returns->total ? '-'.$returns->total : '0.00'); ?></span>
                        </h4></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="text-align:right;"><h4>
                            <span><strong><?= $cashsales->paid ? $this->erp->formatMoney(($cashsales->paid + ($this->session->userdata('cash_in_hand'))) + ($refunds->returned ? $refunds->returned : 0) - ($returns->total ? $returns->total : 0) - $expense) : $this->erp->formatMoney($this->session->userdata('cash_in_hand')-$expense - ($returns->total ? $returns->total : 0)); ?></strong></span>
                        </h4></td>
                </tr>
            </table>
        </div>
