...
<div id="wrapper">
    ...
    <div id="receipt-data">
        <div class="text-center">
            ...
            <?php
            echo "<p>" . $biller->address . " " . $biller->city . " " . $biller->postal_code . " " . $biller->state . " " . $biller->country ." "."<br>Facebook Page : BaoBao Collections".
            ...
            if ($pos_paidd >= $inv->grand_total) {
                ...
                if (count($payments) > 1) {
                    ...
                    <tr>
                        ...
                        <th style="border-right:2px solid #000;border-top:2px solid #000;border-left:none;"
                            class="text-right"><?= $this->erp->formatMoney($payment->pos_paid_usd); ?></th>
                    </tr>
                    <tr>
                ...
                if (count($payments) > 1) {
                    ...
                    if ((($pos_paid + $pos_paid_other) - $inv->grand_total) != 0 || ($this->erp->formatMoney((($pos_paid + $amount_kh_to_us) - $inv->grand_total) * $exchange_rate->rate)) != 0) { ?>
                        ...
                        <tr>
                            ...
                            <th style="border-top:2px dotted #000" class="text-right">
                                <?= number_format(round($payment->pos_balance * $payment->pos_paid_other_rate,-2)); ?>
                                <sup> ៛</sup>
