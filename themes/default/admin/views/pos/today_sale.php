            ...
            <table width="100%" class="stable">
                ...
                <tr>
                    ...
                    <td width="200px;" style="text-align:right;"><h4 style="font-weight:bold;">
                            <span><?= $this->erp->formatMoney($totalsales->total ? $totalsales->total : '0.00'); ?></span>
                        </h4></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="text-align:right;border-top: 1px solid #DDD;"><h4>
                            <span><?= $this->erp->formatMoney($returns->total ? '-'.$returns->total : 0); ?></span>
                        </h4></td>
                </tr>
                <tr>
                ...
                <tr>
                    ...
                    <td style="text-align:right;"><h4>
                            <span><strong><?= $cashsales->paid ? $this->erp->formatMoney(($cashsales->paid + ($this->session->userdata('cash_in_hand'))) - $expense + ($refunds->returned ? $refunds->returned : 0) - ($returns->total ? $returns->total : 0)) : $this->erp->formatMoney($this->session->userdata('cash_in_hand') - $expense - ($returns->total ? $returns->total : 0)); ?></strong></span>
                        </h4></td>
                </tr>
            </table>
        </div>
