...
<div id="wrapper">
    <header id="header" class="navbar">
        <div class="container">
            <a class="navbar-brand" href="<?= admin_url() ?>"><span class="logo"><span class="pos-logo-lg"><?= $Settings->site_name ?></span><span class="pos-logo-sm"><?= lang('pos') ?></span></span><br><span class "btn bblack" id="display_time"></span></a>
                            ...
                            <div id="left-bottom">
                                    ...
                                    <div class="row">
                                      <!--   <div class="col-xs-4" style="padding: 0;">
                                            <div class="btn-group-vertical btn-block">
                                                <button type="button" class="fontsize14 btn btn-warning btn-block btn-flat"
                                                id="suspend">
                                                    <?=lang('suspend'); ?>
                                                </button> 
                                                <button type="button" class="fontsize14 btn btn-danger btn-block btn-flat"
                                                id="reset">
                                                    <?= lang('cancel'); ?>
                                                </button>
                                            </div>
                                        ...
                                        <div class="col-xs-4" style="padding: 0;">
                                            <button type="button" class="fontsize14 btn btn-danger btn-block btn-flat" id="cancel" style="height:67px;">
                                                <?=lang('cancel');?>
                                            </button>
                                        </div>
                                        <div class="col-xs-4" style="padding: 0;">
                                            <div class="btn-group-vertical btn-block">
                                                <button type="button" class="fontsize14 btn btn-info btn-block" id="print_order">
                                                    <?=lang('order');?>
                                                </button>

                                                <button type="button" class="fontsize14 btn btn-primary btn-block" id="print_bill">
                                                    <?=lang('bill');?>
                                                </button>
                                            </div>
                                        </div>
                                        <div class="col-xs-4" style="padding: 0;">
                                            <button type="button" class="fontsize14 btn btn-success btn-block" id="payment" style="height:67px;">
                                ...
                                <div id="payment-con">
                                    <?php for ($i = 1; $i <= 5; $i++) {?>
                                        ...
                                        <input type="hidden" name="amount_kh[]" id="amount_kh_val_<?=$i?>" value=""/>
                                        <input type="hidden" name="exchange_kh[]" id="exchange_kh" value="<?=$exchange_rate->rate ?>"/>
                                        <input type="hidden" name="balance_amount[]" id="balance_amount_<?=$i?>" value=""/>
                                        <input type="hidden" name="balance_amount_kh[]" id="balance_amount_kh_<?=$i?>" value=""/>
                                 ...
                                 <!--       <div class="col-sm-6">
                                    ...
                                    <div>
                                        <table class="table table-bordered table-condensed table-striped" style="font-size: 1.2em; font-weight: bold; margin-bottom: 0;">
                                            <tbody>
                                                <tr>
                                                    <th width="30%" style="text-align:left;font-size:16px !important;">Currency</th>
                                                    <th style="text-align:center;font-size:16px !important;">USD</th>
                                                    <th style="text-align:center;font-size:16px !important;">KHM</th>
                                                </tr>
                                                <tr>
                                                    <td width="30%" style="height: 50px; font-size:16px !important;">Total Payable</td>
                                                    <td class="text-right" style="font-size:16px !important;"><span id="twt"></span></td>
                                                    <td class="text-right" style="font-size:16px !important;"><span class="curr_tpay" rate="4100.0000" id="gtotal_kh"></span></td>
                                                </tr>
                                                <tr>
                                                    <td width="30%" style="height: 50px; font-size:16px !important;">Paid </td>
                                                    <td class="text-right" style="font-size:16px !important;">
                                                        <input name="amount[]" type="text" id="amount_1" value="" class="pa form-control input-lg kb-pad amount" style="text-align:right;">
                                                    </td>
                                                    <td class="text-right" style="font-size:16px !important;">
                                                        <input name="pos_paid_other[]" rate="4100.0000" type="text" id="amount_kh_1" class="form-control input-lg kb-pad amount_kh currencies_payment" style="text-align:right;">
                                                    </td>

                                                </tr>

                                                <tr>
                                                    <td rowspan="2" width="30%" style="text-align:left;font-size:16px !important;">Remaining</td>
                                                    <td class="text-right" style="font-size:16px !important;"><span id="remain_usd_1" class="main_remain_1 main_remain_">0.00</span></td>
                                                    <td class="text-right" style="font-size:16px !important;"><span class="curr_remain_1 curr_remain_" rate="4100.0000" id="remain_kh_1">0</span></td>
                                                </tr>
                                                <tr>
                                                    <td class="text-right" style="font-size:16px !important;"><span id="remain_usd_2" class="main_remain" style="font-size:16px !important;">0.00</span></td>
                                                    <td class="text-right" style="font-size:16px !important;"><span class="curr_remain" rate="4100.0000" id="remain_kh_2">0</span></td>
                                                </tr>
                                                <tr>
                                                    <td rowspan="2" width="30%" style="text-align:left;font-size:16px !important;">Change</td>
                                                    <td class="text-right" style="font-size:16px !important;"><span id="change_usd_1">0.00</span></td>
                                                    <td class="text-right" style="font-size:16px !important;"><span class="curr_change_1" rate="4100.0000" id="change_kh_1">0</span></td>
                                                </tr>
                                                <tr>
                                                    <td class="text-right" style="font-size:16px !important;"><span id="change_usd_2">0.00</span></td>
                                                    <td class="text-right" style="font-size:16px !important;"><span class="curr_change" rate="4100.0000" id="change_kh_2">0</span></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
...
<?php if ($this->input->get('customer')) {?>
        ...
        $('#payment').click(function () {
            ...
            $('#gtotal_kh').text(formatNumber(round_total*exchange_rate,0));
            $('#quick-payable').text(round_total);
            <?php } else {?>
            $('#twt').text(formatMoney(gtotal));
            $('#gtotal_kh').text(formatNumber(gtotal*exchange_rate,0));
        ...
        $(document).on('focus', '.amount_kh', function () {
            ...
            console.log(pi);
            calculateTotals();
        }).on('blur', '.amount_kh', function () {
            calculateTotals();
        }).on('keyup', '.amount_kh', function () {
            calculateTotals();
        });

        function calculateTotals() {
            var total_paying = 0;
            var total_paying_us = 0;
            var total_paying_kh = 0;
            var ia = $(".amount");
            var ia_kh = $(".amount_kh");
            $.each(ia, function (i) {
                var this_amount = formatCNum($(this).val() ? $(this).val() : 0);
                total_paying_us += parseFloat(this_amount);
            });
            $.each(ia_kh, function (i) {
                var this_amount = formatCNum($(this).val() ? $(this).val() : 0);
                total_paying_kh += parseFloat(this_amount);
            });
            total_paying    = formatMoney(total_paying_us+(total_paying_kh/exchange_rate));
...
?>
<script type="text/javascript">
    $(document).on('keyup','#amount_1, #amount_kh_1', function(){
        var paid_usd        = $('#amount_1').val()-0;
        var paid_khm        = $('#amount_2').val()-0;
        var balance         = formatMoney(paid_usd+(paid_khm/exchange_rate)-gtotal);
        var str             = balance.split('.');
        if(balance > 0)
        {
            $('#change_usd_1').text(formatMoney(str[0]));
            $('#change_usd_2').text(formatMoney(balance));
            $('#change_kh_1').text(formatNumber((balance-str[0])*exchange_rate,0));
            $('#change_kh_2').text(formatNumber(balance*exchange_rate,0));
            $('#remain_usd_1').text('0.00');
            $('#remain_usd_2').text('0.00');
            $('#remain_kh_1').text('0.00');
            $('#remain_kh_2').text('0.00');
        }
        if(balance<0){
            balance     = formatMoney(balance*(-1));
            var str     = balance.split('.');
            $('#remain_usd_1').text(formatMoney(str[0]));
            $('#remain_usd_2').text(formatMoney(balance));
            $('#remain_kh_1').text(formatNumber((balance-str[0])*exchange_rate,0));
            $('#remain_kh_2').text(formatNumber(balance*exchange_rate,0));
            $('#remain_usd_2').text(balance);
            $('#change_usd_1').text('0.00');
            $('#change_usd_2').text('0.00');
            $('#change_kh_1').text('0.00');
            $('#change_kh_2').text('0.00');
        }
    });
