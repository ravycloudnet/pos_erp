...
<head>
    ...
    <title>ERP Promotional Page</title>
        ...
        <div class="site-wrapper-inner">
            <div class="cover-container">
                ...
                <div class="inner cover">
                    <h1 class="cover-heading">POS Module for iCloudERP</h1>
                    <p class="lead">iCloudERP is php based web application for small and medium business to manage inventory, sales (with online payments), expenses, customers and warehouses. </p>
                    <p>Please edit themes/<?=$Settings->theme;?>/views/promotions.php</p>
                </div>
                <div class="mastfoot">
                    <div class="inner">
                        <p>iCloudERP by <a href="http://cloudnet.com.kh">CloudNET</a>.</p>
                    </div>
                </div>
            </div>
        </div>
