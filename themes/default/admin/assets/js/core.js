...
function cssStyle() {
    ...
    if($('#sidebar-left').hasClass('minified')) {
        $.cookie('erp_theme_fixed', 'no', { path: '/' });
    ...
    $('#fixed').click(function(e) {
        ...
        if($('#sidebar-left').hasClass('minified')) {
            ...
            if($(this).hasClass('fixed')) {
                ...
                $.cookie('erp_theme_fixed', 'yes', { path: '/' });
            }
            cssStyle();
        }
    });
...
function widthFunctions(e) {
    ...
    if (ww > 1024 && $.cookie('erp_sidebar') != 'minified') {
        $('#main-menu-act').removeClass("minified").addClass("full").find("i").removeClass("fa-angle-double-right").addClass("fa-angle-double-left");
        $("body").removeClass("sidebar-minified");
        $("#content").removeClass("sidebar-minified");
        $("#sidebar-left").removeClass("minified");
...
jQuery(document).ready(function(e) {
    e("#main-menu-act").click(function() {
        if (e(this).hasClass("full")) {
            $.cookie('erp_sidebar', 'minified', { path: '/' });
...
$(function() {
    ...
    $('#log-date').datetimepicker({startDate: startDate, endDate: endDate, format: site.dateFormats.js_sdate, fontAwesome: true, language: 'erp', todayBtn: 1, autoclose: 1, minView: 2 });
...
$(document).ready(function() {
    if ($.cookie('erp_sidebar') == 'minified') {
...
$(document).ready(function() {
    $('#cssLight').click(function(e) {
        e.preventDefault();
        $.cookie('erp_style', 'light', { path: '/' });
        cssStyle();
        return true;
    });
    $('#cssBlue').click(function(e) {
        e.preventDefault();
        $.cookie('erp_style', 'blue', { path: '/' });
        cssStyle();
        return true;
    });
    $('#cssBlack').click(function(e) {
        e.preventDefault();
        $.cookie('erp_style', 'black', { path: '/' });
        cssStyle();
        return true;
    });
...
function openImg(img) {
    var imgwindow = window.open('', 'erp_pos_img');
