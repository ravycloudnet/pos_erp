 ...
 */
$config['site_title']                 = "iCloudERP";       // Site Title, example.com This is not more functional
$config['admin_email']                = "contact@cloudnet.com.kh"; // Admin Email, admin@example.com This is not more functional
