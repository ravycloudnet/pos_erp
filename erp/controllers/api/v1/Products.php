...
class Products extends REST_Controller {
    ...
    protected function setProduct($product) {
        ...
        $product->price = $this->erp->formatDecimal($product->price);
        $product->net_price = $this->erp->formatDecimal($product->tax_method ? $product->price : $product->price-$ctax['amount']);
        $product->unit_price = $this->erp->formatDecimal($product->tax_method ? $product->price+$ctax['amount'] : $product->price);
