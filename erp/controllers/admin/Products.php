...
class Products extends MY_Controller
{
                    ...
                    foreach ($variants as $option) {
                        if ($this->input->post('vt_'.$product->id.'_'.$option->id)) {
                            $barcodes[] = array(
                                ...
                                'code' => $product->code? $product->code : FALSE,
     ...
     ********* Created by Nak *********
     *********** Using Stock **********/
    public function list_using_stock()
    {
      $bc = array(array('link' => base_url(), 'page' => lang('home')), array('link' => site_url('products'), 'page' => lang('products')), array('link' => '#', 'page' => lang('list_stock_using')));
        $meta = array('page_title' => lang('list_stock_using'), 'bc' => $bc);
        $this->page_construct('products/list_using_stock', $meta,$this->data);
    }
    ...
    {
      $bc = array(array('link' => base_url(), 'page' => lang('home')), array('link' => site_url('products'), 'page' => lang('products')), array('link' => '#', 'page' => lang('add_stock_using')));
     ...
     ********* Created by Nak *********
     *********** Add Convert **********/
    public function add_convert($purchase_id = null, $id = NULL)
    {
      $bc = array(array('link' => base_url(), 'page' => lang('home')), array('link' => '#', 'page' => lang('products')));
            $meta = array('page_title' => lang('add_convert'), 'bc' => $bc);
            $this->page_construct('products/add_convert', $meta, $this->data);
    }
